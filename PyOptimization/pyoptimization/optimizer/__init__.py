...
def make_sga(config, executer, newProblem, coding, **kwargs):
	...
	initial = kwargs['initialGen'](random, problem, solutions)
...
def make_nsga_ii(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.nsga_ii(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_spea2(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.spea2(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_gde3(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.nsga_ii(optimizer, solutions) + kwargs['crossoverFetcher'](crossover)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_ibea_epsilon(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.ibea(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_ar(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.ar(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_grea(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.grea(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_epsilon_moea(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.epsilon_moea(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_tdea(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.tdea(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_isnps(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.isnps(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_nsga_iii(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.nsga_iii(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_cdas(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.cdas(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_g_nsga_ii(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.g_nsga_ii(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_r_nsga_ii(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.r_nsga_ii(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
...
def make_monte_carlo_sms_emoa(config, executer, newProblem, coding, **kwargs):
	...
	_kwargs = copy.copy(kwargs)
	_kwargs['fetcher'] = lambda optimizer: kwargs['fetcher'](optimizer) + pyoptimization.optimizer.fetcher.monte_carlo_sms_emoa(optimizer, solutions) + kwargs['crossoverFetcher'](crossover) + kwargs['mutationFetcher'](mutation)
	executer(optimization, config, optimizer, **_kwargs)
